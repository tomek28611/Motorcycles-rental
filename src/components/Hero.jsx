...
const Hero = () => {
    return (
        <div className='w-full h-screen'>
            ...
            <img className="w-36 h-20 absolute top-0 left-4" src={logo} alt="/" />
            <div className="absolute top-12 w-full h-full flex flex-col justify-center text-white">
                <div className='left-[50%] max-w-[1100px] m-auto absolute p-4'>
                    ...
                    <button className='mt-2 bg-slate-200 text-black hover:bg-black/50
                     hover:text-white' onClick={handleClick} >Reserve Motorbike</button>
                </div>
                </div>
            </div>
